    ...
    })(
        {
                ...
                function (t, e, a) {
                    ...
                    function B(t) {
                        var e,
                            ...
                            l = t[2];
                        return (
                            8 >= o ? ((a = (100 * o) / 903.3), (n = 7.787 * (a / 100) + 16 / 116)) : ((a = 100 * Math.pow((o + 16) / 116, 3)), (n = Math.pow(a / 100, 1 / 3))),
            ...
            15: [
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        var e = t.helpers;
                        (t.defaults.bar = { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }),
                            ...
                            (t.controllers.bubble = t.DatasetController.extend({
                                ...
                                updateElement: function (a, i, n) {
                                    ...
                                    e.extend(a, {
                                        ...
                                        _index: i,
                                        _model: {
                                            x: n ? l.getPixelForDecimal(0.5) : l.getPixelForValue("object" == typeof c ? c : NaN, i, f, o.chart.isCombo),
                            ...
                            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                                ...
                                update: function (t) {
                                    ...
                                    if (f < 2 * Math.PI) {
                                        ...
                                        var p = g + f,
                                            ...
                                            C = { width: 0.5 * (M.x - w.x), height: 0.5 * (M.y - w.y) };
                                        (d = Math.min(l / C.width, s / C.height)), (u = { x: (M.x + w.x) * -0.5, y: (M.y + w.y) * -0.5 });
                                    }
                                ...
                                updateElement: function (t, a, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: a,
                                        _model: { x: d + o.offsetX, y: u + o.offsetY, startAngle: c, endAngle: h, circumference: g, outerRadius: m, innerRadius: p, label: b(f.label, a, o.data.labels[a]) },
                                    });
                                    var v = t._model;
                                    this.removeHoverStyle(t),
                                        (i && s.animateRotate) || (0 === a ? (v.startAngle = l.rotation) : (v.startAngle = n.getMeta().data[a - 1]._model.endAngle), (v.endAngle = v.startAngle + v.circumference)),
                                        t.pivot();
                                },
                                removeHoverStyle: function (e) {
            ...
            18: [
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        var a = t.helpers;
                        (t.defaults.line = { showLines: !0, spanGaps: !1, hover: { mode: "label" }, scales: { xAxes: [{ type: "category", id: "x-axis-0" }], yAxes: [{ type: "linear", id: "y-axis-0" }] } }),
                            ...
                            (t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                updateElement: function (t, a, i) {
                                    ...
                                    e.extend(t, {
                                        ...
                                        _index: a,
                                        _scale: d,
                                        _model: { x: f, y: g, innerRadius: 0, outerRadius: i ? S : x, startAngle: i && s.animateRotate ? v : y, endAngle: i && s.animateRotate ? v : k, label: u(c, a, c[a]) },
                                    }),
                                ...
                                return (
                                    ...
                                    s && d
                                        ? (r.retinaScale(i),
                                          ...
                                          l.initialize(),
                                          l)
                                        : (console.error("Failed to create chart: can't acquire context from the given item"), l)
                                );
                            }),
                            r.extend(t.Controller.prototype, {
                                ...
                                update: function (e, a) {
                                    ...
                                    r.each(
                                        ...
                                        i._bufferedRender ? (i._bufferedRequest = { lazy: a, duration: e }) : i.render(e, a);
                                },
                                    ...
                                    o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                                        o.each(e, function (e, i) {
                                            ...
                                            "scales" === i
                                                ...
                                                : "scale" === i
                                                ? (a[i] = o.configMerge(r, t.scaleService.getScaleDefaults(e.type), e))
                                                : !n || "object" != typeof r || o.isArray(r) || null === r || "object" != typeof e || o.isArray(e)
                                                ? (a[i] = e)
                                    ...
                                    (i = r[e]),
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ? (i.mK = n.mK = 0)
                                                : ((s = i.mK / i.deltaK), (d = n.mK / i.deltaK), (c = Math.pow(s, 2) + Math.pow(d, 2)), 9 >= c || ((u = 3 / Math.sqrt(c)), (i.mK = s * u * i.deltaK), (n.mK = d * u * i.deltaK))));
                                var h;
                                for (e = 0; l > e; ++e)
                                    (i = r[e]),
                                        i.model.skip ||
                                            ((a = e > 0 ? r[e - 1] : null),
                                            (n = l - 1 > e ? r[e + 1] : null),
                                            a && !a.model.skip && ((h = (i.model.x - a.model.x) / 3), (i.model.controlPointPreviousX = i.model.x - h), (i.model.controlPointPreviousY = i.model.y - h * i.mK)),
                                            n && !n.model.skip && ((h = (n.model.x - i.model.x) / 3), (i.model.controlPointNextX = i.model.x + h), (i.model.controlPointNextY = i.model.y + h * i.mK)));
                            }),
                        ...
                        var r = (o.easingEffects = {
                            ...
                            easeInElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : 1 === (t /= 1)
                                    ? 1
                                    : (a || (a = 0.3), i < Math.abs(1) ? ((i = 1), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(1 / i)), -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a)));
                            },
                            easeOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : 1 === (t /= 1)
                                    ? 1
                                    : (a || (a = 0.3), i < Math.abs(1) ? ((i = 1), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(1 / i)), i * Math.pow(2, -10 * t) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) + 1);
                            },
                            easeInOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : (a || (a = 1 * (0.3 * 1.5)),
                                      ...
                                      1 > t ? -0.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) * 0.5 + 1);
                            },
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, i) {
                                ...
                                function l(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.options.fullWidth ? u : A), (t.right = t.options.fullWidth ? a - c : A + C), (t.top = L), (t.bottom = L + t.height), (L = t.bottom))
                                        : ((t.left = V), (t.right = V + t.width), (t.top = P), (t.bottom = P + D), (V = t.right));
                                }
                                if (t) {
                                    ...
                                    e.each(g.concat(m), l),
                                        ...
                                        e.each(p, l),
                                        e.each(b, l),
                                        (t.chartArea = { left: A, top: P, right: A + C, bottom: P + D }),
                                        e.each(v, function (e) {
                                    ...
                                    if (n.display) {
                                        ...
                                        a.each(i.legendItems, function (t, e) {
                                            var a = c.measureText(t.text).width,
                                                ...
                                                r = u.x,
                                                l = u.y;
                                            S ? r + n >= s && ((l = u.y += w), u.line++, (r = u.x = i.left + (s - d[u.line]) / 2)) : l + w > i.bottom && ((r = u.x = r + i.columnWidths[u.line] + o.padding), (l = u.y = i.top), u.line++),
                                                y(r, l, t),
                                                (x[e].left = r),
                                                (x[e].top = l),
                                                k(r, l, t, a),
                ...
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        (t.defaults.scale = {
                            ...
                            ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 10, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: t.Ticks.formatters.values },
                        }),
                            (t.Scale = t.Element.extend({
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        (u ? (i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth) : (i.width = d && s.drawTicks ? m : 0),
                                    ...
                                    if (n.display) {
                                        ...
                                        if (g) {
                                            if (
                                                ((o = !1),
                                                h && (P /= 2),
                                                (P + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) &&
                                                    (o = 1 + Math.floor(((P + d.autoSkipPadding) * i.ticks.length) / (i.width - (i.paddingLeft + i.paddingRight)))),
                                                r && i.ticks.length > r)
                                            )
                                        ...
                                        if (
                                            ...
                                            e.each(F, function (t) {
                                                if (
                                                    ...
                                                    var a = t.label;
                                                    if (e.isArray(a)) for (var i = 0, n = -(a.length - 1) * m * 0.75; i < a.length; ++i) l.fillText("" + a[i], 0, n), (n += 1.5 * m);
                                        ...
                                        if (u.drawBorder) {
                                            ...
                                            g ? ((H = U = "top" === n.position ? i.bottom : i.top), (H += j), (U += j)) : ((N = E = "left" === n.position ? i.right : i.left), (N += j), (E += j)),
                                                l.beginPath(),
                                                l.moveTo(N, H),
                                                l.lineTo(E, U),
                                                l.stroke();
                            ...
                            generators: {
                                ...
                                logarithmic: function (t, a) {
                                    for (var i = [], n = e.getValueOrDefault, o = n(t.min, Math.pow(10, Math.floor(e.log10(a.min)))); o < a.max; ) {
                                        i.push(o);
                                        var r, l;
                                        0 === o ? ((r = Math.floor(e.log10(a.minNotZero))), (l = Math.round(a.minNotZero / Math.pow(10, r)))) : ((r = Math.floor(e.log10(o))), (l = Math.floor(o / Math.pow(10, r)) + 1)),
                                            10 === l && ((l = 1), ++r),
                                            (o = l * Math.pow(10, r));
                                    }
                                    var s = n(t.max, o);
                            ...
                            draw: function () {
                                ...
                                if (o.display) {
                                    ...
                                    (i.fillStyle = n(o.fontColor, r.defaultFontColor)),
                                        (i.font = f),
                                        a.isHorizontal()
                                            ? ((l = m + (v - m) / 2), (s = p + (b - p) / 2), (d = v - m))
                                            : ((l = "left" === o.position ? m + u / 2 : v - u / 2), (s = p + (b - p) / 2), (d = b - p), (g = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                                        i.save(),
                                        i.translate(l, s),
                                        i.rotate(g),
                                        (i.textAlign = "center"),
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                drawCaret: function (t, a, i) {
                                    var n,
                                        ...
                                        x = a.height;
                                    "center" === p
                                        ? ("left" === g ? ((n = m), (o = n - h), (r = n)) : ((n = m + v), (o = n + h), (r = n)), (s = b + x / 2), (l = s - h), (d = s + h))
                                        : ("left" === g ? ((n = m + f), (o = n + h), (r = o + h)) : "right" === g ? ((n = m + v - f), (o = n - h), (r = o - h)) : ((o = m + v / 2), (n = o - h), (r = o + h)),
                                          "top" === p ? ((l = b), (s = l - h), (d = l)) : ((l = b + x), (s = l + h), (d = l))),
                                ...
                                draw: function () {
                                    ...
                                    if (0 !== e.opacity) {
                                        ...
                                        this._options.enabled &&
                                            (this.drawBackground(i, e, t, a, n), this.drawCaret(i, a, n), (i.x += e.xPadding), (i.y += e.yPadding), this.drawTitle(i, e, t, n), this.drawBody(i, e, t, n), this.drawFooter(i, e, t, n));
                                    }
                                },
                                handleEvent: function (t) {
                                    var e = this,
                                ...
                                draw: function () {
                                    function t(t, e) {
                                        ...
                                        e._view.steppedLine === !0
                                            ...
                                            : 0 === e._view.tension
                                            ? s.lineTo(a.x, a.y)
                                            : s.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, a.controlPointPreviousX, a.controlPointPreviousY, a.x, a.y);
                                    }
                                    var i = this,
                                        n = i._view,
                                        o = n.spanGaps,
                                    ...
                                    if (d.length && n.fill) {
                                        for (s.beginPath(), c = 0; c < d.length; ++c)
                                            (h = d[c]),
                                                ...
                                                (g = h._view),
                                                0 === c
                                                    ? (l ? s.moveTo(r.x, r.y) : s.moveTo(g.x, r), g.skip || ((u = c), s.lineTo(g.x, g.y)))
                                                    : ((f = -1 === u ? f : d[u]),
                                                      g.skip
                                                          ? o || u !== c - 1 || (l ? s.lineTo(r.x, r.y) : s.lineTo(f._view.x, r))
                                                          : (u !== c - 1 ? (o && -1 !== u ? t(f, h) : l ? s.lineTo(g.x, g.y) : (s.lineTo(g.x, r), s.lineTo(g.x, g.y))) : t(f, h), (u = c)));
                                    ...
                                    for (
                                        ...
                                        (h = d[c]),
                                            (f = e.previousItem(d, c)),
                                            (g = h._view),
                                            0 === c ? g.skip || (s.moveTo(g.x, g.y), (u = c)) : ((f = -1 === u ? f : d[u]), g.skip || ((u !== c - 1 && !o) || -1 === u ? s.moveTo(g.x, g.y) : t(f, h), (u = c)));
                                    s.stroke(), s.restore();
                                },
                            }));
                    };
            ...
            40: [
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        ...
                        (i.elements.rectangle = { backgroundColor: i.defaultColor, borderWidth: 0, borderColor: i.defaultColor, borderSkipped: "bottom" }),
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                determineDataLimits: function () {
                                    ...
                                    var i;
                                    void 0 !== t.options.ticks.min && ((i = e.indexOf(a, t.options.ticks.min)), (t.minIndex = -1 !== i ? i : t.minIndex)),
                                        void 0 !== t.options.ticks.max && ((i = e.indexOf(a, t.options.ticks.max)), (t.maxIndex = -1 !== i ? i : t.maxIndex)),
                                        (t.min = a[t.minIndex]),
                                        (t.max = a[t.maxIndex]);
                                },
                                buildTicks: function () {
                            ...
                            i = t.LinearScaleBase.extend({
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return i.isHorizontal()
                                        ? ((a = i.width - (n + i.paddingRight)), (e = i.left + (a / s) * (l - r)), Math.round(e + n))
                                        : ((a = i.height - (i.paddingTop + o)), (e = i.bottom - o - (a / s) * (l - r)), Math.round(e));
                                },
                                getValueForPixel: function (t) {
                                    var e = this,
                                        a = e.isHorizontal(),
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                determineDataLimits: function () {
                                    ...
                                    (a.min = s(n.min, a.min)),
                                        (a.max = s(n.max, a.max)),
                                        a.min === a.max && (0 !== a.min && null !== a.min ? ((a.min = Math.pow(10, Math.floor(e.log10(a.min)) - 1)), (a.max = Math.pow(10, Math.floor(e.log10(a.max)) + 1))) : ((a.min = 1), (a.max = 10)));
                                },
                                buildTicks: function () {
                                    var a = this,
                                        i = a.options,
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        o.isHorizontal()
                                            ? ((n = e.log10(o.end) - e.log10(r)), 0 === l ? (i = o.left + u) : ((a = o.width - (u + o.paddingRight)), (i = o.left + (a / n) * (e.log10(l) - e.log10(r))), (i += u)))
                                            : ((a = o.height - (s + d)),
                                              0 !== r || h.reverse
                                                  ? 0 === o.end && h.reverse
                                                      ? ((n = e.log10(o.start) - e.log10(o.minNotZero)),
                                                        (i = l === o.end ? o.top + s : l === o.minNotZero ? o.top + s + 0.02 * a : o.top + s + 0.02 * a + ((0.98 * a) / n) * (e.log10(l) - e.log10(o.minNotZero))))
                                                      : ((n = e.log10(o.end) - e.log10(r)), (a = o.height - (s + d)), (i = o.bottom - d - (a / n) * (e.log10(l) - e.log10(r))))
                                                  : ((n = e.log10(o.end) - e.log10(o.minNotZero)),
                                                    (i = l === r ? o.bottom - d : l === o.minNotZero ? o.bottom - d - 0.02 * a : o.bottom - d - 0.02 * a - ((0.98 * a) / n) * (e.log10(l) - e.log10(o.minNotZero))))),
                                        i
                                    );
                                },
                                getValueForPixel: function (t) {
                                    ...
                                    return (
                                        n.isHorizontal()
                                            ? ((i = n.width - (n.paddingLeft + n.paddingRight)), (a = n.start * Math.pow(10, ((t - n.left - n.paddingLeft) * o) / i)))
                                            : ((i = n.height - (n.paddingTop + n.paddingBottom)), (a = Math.pow(10, ((n.bottom - n.paddingBottom - t) * o) / i) / n.start)),
                                        a
                                    );
                                },
                            });
                                            ...
                                            (e.each(t.ticks, function (r, l) {
                                                if (l > 0 || i.reverse) {
                                                    var c = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l]),
                                                        h = t.yCenter - c;
                                                    if (n.display && 0 !== l)
                                                        if (((d.strokeStyle = e.getValueAtIndexOrDefault(n.color, l - 1)), (d.lineWidth = e.getValueAtIndexOrDefault(n.lineWidth, l - 1)), i.lineArc))
                            ...
                            var e = t.helpers,
                                ...
                                o = t.Scale.extend({
                                                    ...
                                                    "object" == typeof n.data[0] && null !== n.data[0]
                                                        ? e.each(
                                                              ...
                                                              function (e) {
                                                                  ...
                                                                  a.isValid() &&
                                                                      (t.options.time.round && a.startOf(t.options.time.round),
                                                                      r.push(a),
                                                                      l && ((t.firstTick = null !== t.firstTick ? i.min(t.firstTick, a) : a), (t.lastTick = null !== t.lastTick ? i.max(t.lastTick, a) : a)));
                                                              },
                                                              t
                                                          )
                                                        : (r = a),
                                    ...
                                    buildTicks: function () {
                                        ...
                                        if (((i.ctx.font = l), (i.ticks = []), (i.unitScale = 1), (i.scaleSizeInUnits = 0), i.options.time.unit))
                                        ...
                                        (0 !== M || 0 === i.scaleSizeInUnits) &&
                                            (i.options.time.max
                                                ? (i.ticks.push(i.lastTick.clone()), (i.scaleSizeInUnits = i.lastTick.diff(i.ticks[0], i.tickUnit, !0)))
                                                : (i.ticks.push(i.lastTick.clone()), (i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0)))),
                                            i.ctx.restore(),
                                            (i.labelDiffs = void 0);
                                    },
                                    getLabelForIndex: function (t, e) {
                                    ...
                                    getPixelForValue: function (t, e, a) {
                                        ...
                                        if (
                                            ...
                                            null === n && ((t && t.isValid) || (t = i.parseTime(i.getRightValue(t))), t && t.isValid && t.isValid() && (n = t.diff(i.firstTick, i.tickUnit, !0))),
                                            null !== n)
                                        ) {
