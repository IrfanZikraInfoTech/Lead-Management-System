...
$(window).on("load", function () {
  ...
  function proposal_convert_template(invoker) {
    ...
    var rel_type = $(invoker).data("rel-type");
    var rel_id = $(invoker).data("rel-id");
    ...
    requestGet(
      ...
      $('#typeSelector').val(rel_type);
      $('#typeSelector').prop('disabled', 'disabled');
      $('#invoice_lead_dropdown').prop('disabled', 'disabled');
      ...
      if (rel_type === 'customer') {
          ...
          $.get(admin_url + 'leads/get_all_leads', function(response) {
            ...
            var selectedLead = rel_id; // Get the lead ID to be selected
  ...
  function add_item_to_table(data, itemid, merge_invoice, bill_expense) {
    ...
    get_taxes_dropdown_template(tax_name, data.taxname).done(function (
      ...
      table_row +=
        ...
        var uploadedFileName = $('#pdfUpload').val().split('\\').pop();

        // Add the file column 
        if (uploadedFileName && uploadedFileName !== "") {
            table_row += '<td class="file_name">' + uploadedFileName + '</td>';
        } else {
            table_row += '<td class="file_name">No file uploaded</td>';
        }
      }  
      ...
      clientid: {
        required: {
          depends: function () {
            ...
            var typeSelectedAsLead = $("select#typeSelector").val() === 'lead'; // Check if type is selected as lead
            return !customerRemoved && !typeSelectedAsLead; // Allow clientid to be null if type is lead
          },
        },
      },
      date: "required",
